...
class Environment(environment.Environment):
    ...
    def __init__(self, interface: Interface, params):
        ...
        aircoil_list = [
                        "XFEL.MAGNETS/MAGNET.ML/QF.2749.T4/CURRENT.SP",
                        "XFEL.MAGNETS/MAGNET.ML/QF.2761.T4/CURRENT.SP",
                        "XFEL.MAGNETS/MAGNET.ML/QF.2773.T4/CURRENT.SP",
                        "XFEL.MAGNETS/MAGNET.ML/QF.2785.T4/CURRENT.SP"
                        ]
        ...
        if obs == 'sases_average':
            ...
            for i in range(30):
                sa = self.interface.get_value(
                    "XFEL.FEL/XGM/XGM.3130.T10/INTENSITY.SA3.RAW.TRAIN")
                values.append(sa)
                time.sleep(0.1)
